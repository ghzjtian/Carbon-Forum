...
SetStyle('api', 'API');//设置路径为 /view/api 路径

//ID 为被关注的用户的 ID .
//ID , TYPE , ACTION
//<?php echo $UserInfo['ID']; , 4, 3
//<?php echo $UserInfo['ID']; , 3, 'Block', true, this)

    ...
    <div class="sider-box">
        <div class="sider-box-title">
            ...
            <span class="float-right"><a
                        href="<?php echo $Config['WebsitePath']; ?>/login?logout=<?php echo $CurUserCode; ?>"><?php echo $Lang['Log_Out']; ?></a></span>
        </div>
        <div class="sider-box-content">
...
if ($HotTagsArray) {
    ...
    <div class="sider-box">
        <div class="sider-box-title">
            ...
            <span class="float-right"><a
                        href="<?php echo $Config['WebsitePath']; ?>/tags"><?php echo $Lang['Show_More']; ?></a></span>
        </div>

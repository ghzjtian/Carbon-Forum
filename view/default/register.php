...
//   load javaScript 中，后面接上 version 的作用(当有修改时，浏览器强制刷新.): https://stackoverflow.com/questions/3466989/what-does-appending-v-1-to-css-and-javascript-urls-in-link-and-script-tags-do
    ...
    <div class="main-box">
        <?php if ($Error) { ?>
            <p class="red fs14" style="margin-left:60px;">
                › <?php echo $Error; ?> <br/></p>
        <?php } ?>
<!--        onsubmit: When you submit the form, a function is triggered which alerts some text.-->
...
<!--                    检查用户名的合法性(>=4&&=<20),用户名是否已经注册.   -->
                    <td width="auto" align="left"><input type="text" name="UserName" id="UserName" class="sl w200"
                                                         value="<?php echo htmlspecialchars($UserName); ?>"
                                                         onblur="CheckUserName()"/></td>
                </tr>
                <tr>
                    <td width="180" align="right"><?php echo $Lang['Email']; ?></td>
                    <td width="auto" align="left"><input type="text" name="Email" id="Email" class="sl w200"
                                                         value="<?php echo htmlspecialchars($Email); ?>"
                                                         onblur="CheckMail()"/></td>
                </tr>
                <tr>
                    <td width="180" align="right"><?php echo $Lang['Password']; ?></td>
                    <td width="auto" align="left"><input type="password" name="Password" id="Password" class="sl w200"
                                                         value="" onblur="CheckPassword()"/></td>
                </tr>
                <tr>
                    <td width="180" align="right"><?php echo $Lang['Verification_Code']; ?></td>
                    <td width="auto" align="left">
                        <label><input type="text" name="VerifyCode" class="w100"

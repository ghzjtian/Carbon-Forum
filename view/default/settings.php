                ...
                <div>
                    ...
                    <div class="float-right w300" style="margin-right:20px">
                        ...
                        <form method="post" enctype="multipart/form-data"
                              action="<?php echo $Config['WebsitePath']; ?>/settings#settings1">
                            ...
                            <br/>
                            <input type="submit" value="<?php echo $Lang['Upload_Avatar']; ?>" name="submit"
                                   class="textbtn"/>
                        </form>
                    </div>
                    <div class="c"></div>
                ...
                <form method="post" action="<?php echo $Config['WebsitePath']; ?>/settings#settings2">
                    ...
                    <table cellpadding="5" cellspacing="8" border="0" width="100%" class="fs14">
                        ...
                        <tr>
                            ...
                            <td width="auto" align="left"><input type="text" class="w300" name="UserMail" id="Email"
                                                                 onblur="CheckMail()"
                                                                 value="<?php echo $CurUserInfo['UserMail']; ?>"/>
                                <br/><?php echo $Lang['Ensure_That_Email_Is_Correct']; ?></td>
                        </tr>
                        <tr>
                            <td width="180" align="right"><?php echo $Lang['Homepage']; ?></td>
                            <td width="auto" align="left"><input type="text" class="w300" name="UserHomepage"
                                                                 value="<?php echo $CurUserInfo['UserHomepage']; ?>"/>
                            </td>
                        </tr>
                        <tr>
                            <td width="180" align="right"><?php echo $Lang['Introduction']; ?></td>
                            <td width="auto" align="left"><textarea class="w300 h160"
                                                                    name="UserIntro"><?php echo $CurUserInfo['UserIntro']; ?></textarea>
                            </td>
                        </tr>
                        <tr>
            ...
            <div>
                <table cellpadding="5" cellspacing="8" border="0" width="100%" class="fs14">
                    ...
                    foreach ($CurUserOauthData as $Value) {
                        ...
                        <tr>
                            <td width="180" align="right"><img
                                        src="<?php echo $Config['WebsitePath'] . $OauthData[$Value['AppID']]['LogoUrl']; ?>"/>
                            </td>
                            <td width="auto" align="left" class="grey">
                                <?php echo $Value['AppUserName'] ? $Value['AppUserName'] : 'Unknown'; ?>
                    ...
                    foreach ($OauthData as $Value) {
                        ...
                        <tr>
                            <td width="180" align="right"><img
                                        src="<?php echo $Config['WebsitePath'] . $Value['LogoUrl']; ?>"/></td>
                            <td width="auto" align="left">
                    ...
                    <table cellpadding="5" cellspacing="8" border="0" width="100%" class="fs14">
                        ...
                        if (!$DoNotNeedOriginalPassword) {
                            ...
                            <tr>
                                ...
                                <td width="auto" align="left"><input type="password" class="w300"
                                                                     name="OriginalPassword" value=""/></td>
                            </tr>
                            <?php
                        }
                        ?>
                        <tr>
                            ...
                            <td width="auto" align="left"><input type="password" class="w300" name="NewPassword"
                                                                 id="Password" value=""/></td>
                        </tr>
                        <tr>
                            <td width="180" align="right"><?php echo $Lang['Confirm_New_Password']; ?></td>
                            <td width="auto" align="left"><input type="password" class="w300" name="NewPassword2"
                                                                 value=""/></td>
                        </tr>
                        <tr>
                            <td width="180" align="right"></td>
                            <td width="auto" align="left"><input type="submit"
                                                                 value="<?php echo $Lang['Change_Password']; ?>"
                                                                 name="submit" class="textbtn"/></td>
                        </tr>

...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<?php echo $Config['WebsitePath']; ?>/static/css/mobile/appframework.css?version=<?php echo CARBON_FORUM_VERSION; ?>"/>
    <link rel="stylesheet" type="text/css"
    ...
    <script type="text/javascript" charset="utf-8"
            src="<?php echo $Config['WebsitePath']; ?>/static/js/mobile/appframework.ui.min.js?version=<?php echo CARBON_FORUM_VERSION; ?>"></script>
    <script type="text/javascript" charset="utf-8"
            src="<?php echo $Config['WebsitePath']; ?>/static/js/mobile/global.js?version=<?php echo CARBON_FORUM_VERSION; ?>"></script>
    <script type="text/javascript" charset="utf-8"
    ...
    <div class="view" id="ReplyView">
        <div class="pages">
            <div class="panel" id="Reply">
                ...
                <p><a class="button green block" href="#main" data-transition="up-reveal:dismiss"
                      id="ReplyViewSubmitButton"></a></p>
                <p><a class="button block" href="#main" data-transition="up-reveal:dismiss"
                      id="ReplyViewCancelButton"></a></p>
            </div>
        </div>
    </div>
    <script type="text/javascript">
                    ...
                    <div class="input-group">
                        ...
                        <p>
                            <input type="text" name="UserName" id="UserName"
                                   placeholder="<?php echo $Lang['UserName']; ?>" value=""/>
                        </p>
                        <p>
                            <input type="password" name="Password" id="Password"
                                   placeholder="<?php echo $Lang['Password']; ?>" value=""/>
                        </p>
                        <p>
                            <input type="text" name="VerifyCode" id="VerifyCode"
                                   placeholder="<?php echo $Lang['Verification_Code']; ?>"
                                   onclick="document.getElementById('Verification_Code_Img').src='<?php echo $Config['WebsitePath']; ?>/seccode.php';"
                                   value="" placeholder="<?php echo $Lang['Verification_Code']; ?>" style="width:66%;"/>
                            <img src="" id="Verification_Code_Img" style="cursor: pointer;" onclick="this.src+=''"
                                 style="width:33%;" align="middle"/>
                            <br style="clear:both"/>
                        </p>
                        <p>
                            <a href="<?php echo $Config['WebsitePath']; ?>/register"
                               class="button"><?php echo $Lang['Sign_Up']; ?></a>
                                    ...
                                    <a href="<?php echo $Config['WebsitePath']; ?>/oauth-<?php echo $Value['ID']; ?>"
                                       data-ignore="True">
                                        <img src="<?php echo $Config['WebsitePath'] . $Value['ButtonImageUrl']; ?>"
                                             alt="<?php echo $Value['Alias'] . ' ' . $Lang['Log_In']; ?>"/>
                                    </a>&nbsp;&nbsp;
                                    <?php
                                }
                            }

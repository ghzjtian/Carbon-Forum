...
<ul class="list topic-list">
    ...
    if ($Page > 1) {
        ?>
        <li class="pagination"><a href="<?php echo $Config['WebsitePath']; ?>/page/<?php echo($Page - 1); ?>"
                                  data-transition="slide"><?php echo $Lang['Page_Previous']; ?></a></li>
        <?php
    }
        ...
        <li>
            ...
            <div class="content">
                <a href="<?php echo $Config['WebsitePath']; ?>/t/<?php echo $Topic['ID']; ?>"
                   data-transition="slide"<?php echo ($Topic['Replies'] < $Config['PostsPerPage']) ? ' data-refresh="true"' : ''; ?>>
    ...
    if ($Page < $TotalPage) {
        ?>
        <li class="pagination"><a href="<?php echo $Config['WebsitePath']; ?>/page/<?php echo($Page + 1); ?>"
                                  data-transition="slide" data-refresh="true"><?php echo $Lang['Page_Next']; ?></a></li>
        <?php
    }
    ?>
</ul>